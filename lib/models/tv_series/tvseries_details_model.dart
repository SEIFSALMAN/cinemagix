...
TvSeriesDetailModel tvSeriesDetailModelFromJson(String str) => TvSeriesDetailModel.fromJson(json.decode(str));

String tvSeriesDetailModelToJson(TvSeriesDetailModel data) => json.encode(data.toJson());
...
class Season {
  ...
  factory Season.fromJson(Map<String, dynamic> json) => Season(
    airDate: DateTime.parse(json["air_date"] ?? "${DateTime.now()}"),
